      ...
      <header className="mb-12 text-center max-w-2xl mx-auto">
        ...
        <div className="mt-8 relative max-w-md mx-auto">
          <input 
            ...
            className="w-full px-6 py-4 rounded-2xl border border-slate-200 shadow-sm focus:ring-2 focus:ring-blue-500 outline-none text-sm font-medium"
          />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto pb-10">
        ...
        {filteredLinks.length === 0 && (
          <div className="col-span-full text-center py-20">
            <p className="text-slate-400 font-black uppercase tracking-widest">No resources match your search.</p>
          </div>
        )}
      </div>
